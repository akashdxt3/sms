...
function Home() {
    ...
    function sendSMS(e) {
        ...
        axios.get(`https://2factor.in/API/R1/?module=TRANS_SMS&apikey=e22905d7-a75a-11ec-a4c2-0200cd936042&to=${mobileNumber}&from=DRMSTK&templatename=request&var1=${collection}`).then((resp) => {
                    ...
                    <div>
                        <form onSubmit={(e) => sendSMS(e)} className='mt-5'>
                            ...
                            <select className="form-select" aria-label="Default select example" required onChange={(e) => setCollection(e.target.value)} value={collection}>
                                ...
                                <option value="https://supertube.app/apk">Supertube</option>
                                <option value="https://supermate.app/apk">Supermate</option>
                                <option value="https://mobfry.com/app">Mobfry</option>
                                <option value="https://primehut.in/app">Primehut</option>
                                <option value="https://yumvideo.in/app">Yumvideo</option>
                                <option value="https://yumcinema.com/app">Yumcinema</option>
                                <option value="https://mobfry.com/app">Funtv</option>
                            </select>
